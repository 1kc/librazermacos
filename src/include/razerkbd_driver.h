...
#define USB_DEVICE_ID_RAZER_BLADE_BASE_2020 0x0255
#define USB_DEVICE_ID_RAZER_BLADE_STEALTH_EARLY_2020 0x0252
#define USB_DEVICE_ID_RAZER_BLADE_ADVANCED_2020 0x0253
#define USB_DEVICE_ID_RAZER_BLADE_STEALTH_2020 0x0259
